...
1199 tests passing. 0 lint warnings. Runs on Termux ARM64 (Snapdragon 680).
...
```bash
npx vitest run       # run all tests (1199)
...
| `useSlashCommands/handlers/chat.test.js` | Unit — /search handler + error paths | 4 |
