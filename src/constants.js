...
export const BASE_SYSTEM = [
  ...
  '10. Edit file yang sudah ada → WAJIB patch_file (old_str+new_str harus unik, min 2 baris context).',
  '    write_file hanya untuk: file baru, atau restruktur total.',
  '13. Task edit file yang JELAS → LANGSUNG patch_file atau write_file action, tanpa prose penjelasan dulu.',
