...
> Generated: 2026-03-22T08:50:36.160Z
> Files: 84 | Symbols: 113

---

## 🔥 `src/components/panels.jsx` _(10L, salience:100)_

## 🔥 `src/plugins/brightness.js` _(14L, salience:71)_

## 🔥 `src/themes/index.js` _(19L, salience:56)_
- ◆ `THEMES_MAP`
- ◆ `THEME_KEYS`
- ◆ `DEFAULT_THEME`

## 🔥 `src/hooks/useBrightness.js` _(26L, salience:39)_
...
## ⭐ `src/components/KeyboardRow.jsx` _(71L, salience:15)_
- ⚛ `KeyboardRow({ onInsert, T })`

## ⭐ `src/hooks/useMediaHandlers.js` _(69L, salience:15)_
- 🪝 `useMediaHandlers({ setVisionImage, setInput, haptic, setDragOver })`

## ⭐ `src/components/AppHeader.jsx` _(76L, salience:14)_
- ⚛ `AppHeader({ T, ui, project, file, chat, growth, saveFolder, undoLastEdit, haptic })`

## ⭐ `eslint.config.js` _(72L, salience:14)_

## ⭐ `src/components/panels.tools.jsx` _(604L, salience:13)_
...
## ⭐ `src/utils.js` _(223L, salience:11)_
- ƒ `countTokens(msgs)`
- ƒ `getFileIcon(name)`
- ƒ `hl(code, lang = '')`
...
## · `src/api.js` _(214L, salience:10)_
...
## · `src/components/VoiceBtn.jsx` _(133L, salience:10)_
...
## · `src/themes/ink.js` _(131L, salience:8)_

## · `src/themes/mybrand.js` _(124L, salience:8)_

## · `src/themes/neon.js` _(133L, salience:8)_

## · `src/themes/obsidian.js` _(126L, salience:8)_

## · `src/components/MsgBubble.jsx` _(338L, salience:7)_
...
## · `src/components/ThemeEffects.jsx` _(159L, salience:7)_
- ⚛ `ThemeEffects({ T })`
...
## · `src/components/panels.git.jsx` _(531L, salience:7)_
...
## · `src/hooks/useGrowth.js` _(154L, salience:7)_
- 🪝 `useGrowth`

## · `src/hooks/useNotifications.test.js` _(152L, salience:7)_

## · `src/themes/aurora.js` _(141L, salience:7)_

## · `src/utils.test.js` _(149L, salience:7)_

## · `src/branch.coverage.test.js` _(170L, salience:6)_

## · `src/components/LivePreview.jsx` _(202L, salience:6)_
...
## · `src/hooks/useChatStore.js` _(212L, salience:6)_
- 🪝 `useChatStore`

## · `src/hooks/useUIStore.js` _(203L, salience:6)_
- 🪝 `useUIStore`

## · `src/components/FileTree.jsx` _(294L, salience:5)_
- ⚛ `FileIcon({ name, size=13 })`
- ⚛ `FileTree({ folder, onSelectFile, selectedFile, T })`

## · `src/components/GlobalFindReplace.jsx` _(243L, salience:5)_
- ⚛ `GlobalFindReplace({ folder, onOpenFile, onClose, T })`

## · `src/components/Terminal.jsx` _(339L, salience:5)_
...
## · `src/features.branch.test.js` _(221L, salience:5)_

## · `src/features.test.js` _(215L, salience:5)_

## · `src/hooks/useDevTools.test.js` _(201L, salience:5)_

## · `src/hooks/useFileStore.js` _(251L, salience:5)_
- 🪝 `useFileStore`

## · `src/hooks/useMediaHandlers.test.js` _(201L, salience:5)_

## · `src/hooks/useProjectStore.js` _(237L, salience:5)_
- 🪝 `useProjectStore`

## · `src/uistore.test.js` _(193L, salience:5)_

## · `src/App.jsx` _(324L, salience:4)_
- ⚛ `App`

## · `src/api.branch.test.js` _(256L, salience:4)_

## · `src/api.extended.test.js` _(254L, salience:4)_

## · `src/components/AppPanels.jsx` _(269L, salience:4)_

## · `src/components/FileEditor.jsx` _(847L, salience:4)_
- ⚛ `Minimap({ viewRef, T })`
- ⚛ `Breadcrumb({ viewRef, T })`
- ◆ `FileEditor`

## · `src/features.bgagent.test.js` _(246L, salience:4)_
...
## · `src/useFileStore.branch.test.js` _(292L, salience:3)_

## · `src/utils.extended.test.js` _(389L, salience:3)_

## · `src/utils.integration.test.js` _(344L, salience:3)_

## · `src/components/AppChat.jsx` _(515L, salience:2)_

## · `src/hooks/useAgentLoop.js` _(687L, salience:2)_
- 🪝 `useAgentLoop({
...
## · `src/hooks/useApprovalFlow.test.js` _(512L, salience:2)_

## · `src/hooks/useSlashCommands.branch.test.js` _(531L, salience:2)_

## · `src/multitab.test.js` _(434L, salience:2)_

## · `src/hooks/useAgentLoop.branch.test.js` _(919L, salience:1)_

## · `src/hooks/useSlashCommands.js` _(772L, salience:1)_

## · `src/hooks/useSlashCommands.test.js` _(1362L, salience:1)_
