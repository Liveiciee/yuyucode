...
```
/effort deep
useSlashCommands.js is getting too long — extract each command into its own named function
```

What happens:
1. Reads `useSlashCommands.js` in chunks
...
What happens:
1. Reads `useSlashCommands.js` to understand the pattern
